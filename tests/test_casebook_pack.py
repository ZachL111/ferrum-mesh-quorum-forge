"""Regression checks for the ferrum-mesh-quorum-forge casebook."""
...
from casebook.harness import assert_expected, ferrum_mesh_quorum_forge_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(ferrum_mesh_quorum_forge_summary(), assert_expected())
